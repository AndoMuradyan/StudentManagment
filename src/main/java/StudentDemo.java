...
public class StudentDemo {
    ...
    private static void initData() {
        ...
        Lesson java = new Lesson("java", "teacher", 7, 1234, stringToDate("03/05/2022"));
        Lesson mysql = new Lesson("mysql", "teacher mysql", 7, 1234, stringToDate("03/06/2022"));
        Lesson php = new Lesson("php", "teacher php", 7, 1234, stringToDate("03/08/2022"));
